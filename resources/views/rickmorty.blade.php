    ...
    <div class="content1">
        <div class="slideselenco">
            ...
            <div class="slideelenco">
                ...
                <br><br><br><br>
                <h3 class="elencotxt">Traduzido do inglês-<br>Jerry Smith é um dos personagens principais da série animada de televisão americana Rick and Morty. Criado por Justin Roiland e Dan Harmon, Jerry é retratado como um perdedor medíocre e desempregado que encontra conteúdo em sua vida simples.<br><br><br><br><br><center><a class="links" href="https://en.wikipedia.org/wiki/Jerry_Smith_(Rick_and_Morty)" target="_blank">Wikipedia (inglês)</a></center></h3>  
            </div>
            <div class="slideelenco">
